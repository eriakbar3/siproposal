                      ...
                      <section class="panel">
	                      ...
	                      <section class="panel">
	                          <div class="panel-body">
	                              ...
	                              <?php 
	                              $get_id = $_GET['id'];
	                              $sql = $link->prepare("SELECT * FROM rppi_pengembangan WHERE id_rppi_pengembangan = '$get_id' ");
	                              $sql->execute();
	                              $data = $sql->fetch(PDO::FETCH_OBJ);
	                              if (isset($_POST['submit'])) {
	                              		$nama_rppi = $_POST['nama_rppi'];

	                              		$sql = $link->prepare("UPDATE rppi_pengembangan SET nama_rppi_pengembangan = ? WHERE id_rppi_pengembangan = '$get_id' ");
	                               ...
	                               ?>
	                                  ...
	                                  <div class="form-group">
	                                      ...
	                                      <div class="col-lg-10">
	                                          <input type="text" class="form-control" name="nama_rppi" value="<?php echo $data->nama_rppi_pengembangan; ?>" autofocus required>
	                                      </div>
	                                  </div>
