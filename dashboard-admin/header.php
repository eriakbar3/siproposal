      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a href="index.php?act=data-satker">
                          <i class="fa fa-bars"></i>
                  ...
                  <li>
                      <a href="index.php?act=data-rppi-penelitian">
                          <i class="fa fa-bars"></i>
                          <span>RPPI Penelitian</span>
                      </a>
                  </li>

                  <li>
                      <a href="index.php?act=data-rppi-pengembangan">
                          <i class="fa fa-bars"></i>
                          <span>RPPI Pengembangan</span>
                      </a>
                  </li>

                  <li>
                      <a href="index.php?act=data-kepakaran">
                          <i class="fa fa-bars"></i>
                          <span>Data Kepakaran</span>
                      </a>
                  </li>
