	                          ...
	                          <div class="panel-body">
                                  ...
                                  echo $kode;
	                               ...
	                               ?>
	                                  ...
	                                  <div class="form-group">
	                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Nama Pelaksana Data</label>
	                                      <div class="col-lg-10">
	                                          <input type="text" name="nama_pelaksana_data" class="form-control" required>
	                                      </div>
	                                  </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Kegiatan Baru</label>
                                        <div class="col-lg-10">
                                          <div class="radio">
                                            <label><input type="radio" name="kegiatan_baru" value="Y" checked>Ya</label>
                                          </div>
                                          <div class="radio">
                                            <label><input type="radio" name="kegiatan_baru" value="T" checked>Tidak</label>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Kegiatan Lanjutan</label>
                                        <div class="col-lg-10">
                                          <div class="radio">
                                            <label><input type="radio" name="kegiatan_lanjutan" value="Y"  id="lanjutan">Ya</label>
                                          </div>
                                          <div class="radio">
                                            <label><input type="radio" name="kegiatan_lanjutan" value="T"  id="lt">Tidak</label>
                                          </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Usulan Biaya</label>
                                        <div class="col-lg-10">
                                          <input type="text" name="usulan_biaya" value=""class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Ringkasan Proposal</label>
                                        <div class="col-lg-10">
